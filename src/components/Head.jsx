...
export default function Header() {
  return (
  <div class="p-8 md:pt-24 h-full w-full flex items-center justify-center bg-gradient-to-tr from-zinc-800 to-indigo-600 shadow-2xl">
    <div className='grid md:grid-cols-2 max-w-[1340px] m-auto '>
      <div className='max-w-[650px] flex flex-col sm:col-span-1 justify-center md:items-start w-full py-8'>
