        ...
        <div>
          <div className="flex justify-between sm:w-[300px] pt-2 text-2xl">
            <a
              ...
              href="https://github.com/SwiftWindz"
            >
              <FaGithub />
            </a>
            <a
              className="hover:text-violet-400"
              href="https://github.com/SwiftWindz/personal-page"
            >
              <FaCode />
            </a>
            <a
              className="hover:text-violet-400"
              href="https://www.linkedin.com/in/phil-ganem/"
            >
              <FaLinkedin />
            </a>
            <a
              ...
              aria-disabled="false"
              target="_self"
              href="mailto:philthesoftdev@gmail.com?subject=Hello there!"
            >
              <MdEmail />
            </a>
          </div>
