        ...
        <div className='grid grid-cols-1 lg:grid-cols-3 px-8 gap-6 place-items-center'>
            ...
            <div className=" pt-8">
              <div className="rounded-lg shadow-lg bg-zinc-800 max-w-xl">
                ...
                <div className="p-6">
                  <h5 className="text-[#8b5cf6] text-xl font-bold mb-2 text-center ">Multi-User Dungeon</h5>
            ...
            <div className=" pt-8">
              <div className="rounded-lg shadow-lg bg-zinc-800 max-w-xl">
                ...
                <div className="p-6">
                  <h5 className="text-[#8b5cf6]   text-xl font-bold mb-2 text-center">Webcheckers</h5>
                  <p className="text-gray-100 text-base text-center">
            ...
            <div className=" pt-8">
              <div className="rounded-lg shadow-lg bg-zinc-800 max-w-xl">
                ...
                <div className="p-6">
                  <h5 className="text-[#8b5cf6]   text-xl font-bold mb-2 text-center">Cocktail Cabinet</h5>
                  <p className="text-gray-100 text-base text-center">
