  ...
  return (
    <div className='w-screen h-full bg-gradient-to-tl to-[#8b5cf6] from-zinc-400 font-outfit pb-24'>
      <div className='pt-24 rounded-xl'>
          ...
          <div className='pt-10'>
          <form className='bg-zinc-800 rounded-2xl w-[350px] h-[450px] md:w-[700px] md:h-[375px] drop-shadow-xl ' onSubmit={handleSubmit}>
            <div className='grid grid-cols-1 md:grid-cols-2 md:p-6 px-4'>
              ...
              <div className='border-t-2 md:border-t-0 pb-8'>
                ...
                <textarea className='h-[150px] md:h-[250px] w-[300px] bg-zinc-800 focus:outline-none resize-none md:pl-1' placeholder='Type your message here...' required={true} id="message" name="message"/>
