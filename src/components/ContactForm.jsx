...
const [state, handleSubmit] = useForm("xoqrbvgv");
  ...
  return (
    <div className='w-full bg-gradient-to-br from-violet-600 to-gray-400 font-outfit pb-20'>
      <div className='h-screen pt-20  rounded-xl'>
          ...
          <div className='pt-10'>
          <form className='bg-zinc-600 p-5 pt-10 rounded-lg w-[300px] h-[450px] md:w-[500px] md:h-[500px] drop-shadow-xl ' onSubmit={handleSubmit}>
