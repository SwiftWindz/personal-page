      ...
      <div className="px-2 w-full">
        <div className="flex justify-center py-8">
          <ul className="hidden md:flex flex-row text-center rounded-2xl shadow-2xl p-2 px-8 bg-zinc-800 text-white font-outfit">
            <button>
              <li className="hover:text-violet-400 px-8">
                <Link to="/">About</Link>
              </li>
            </button>
            <button>
        ...
        <div className="flex md:hidden mt-[-75px]" onClick={handleClick}>
          {!nav ? (
            <div className="pt-5">
              <button>
                <MenuIcon className="w-10 animate-pulse text-zinc-800" />
              </button>
            </div>
          ) : (
            <div className="w-screen sm:h-[50px] md:h-[80px] z-10 fixed drop-shadow-lg">
              <button>
                <XIcon className="text-zinc-400 pt-5 w-10 animate-pulse py-5" />
              </button>
            </div>
          )}
        </div>
      ...
      <div className="md:hidden font-outfit">
        <div
          className={
            !nav
              ? "hidden"
              : "absolute bg-zinc-800 w-screen h-screen text-white"
          }
        >
          <ul className={"px-8 pt-16"}>
            <h2 className="py-1 font-bold">PG</h2>
            <li className="hover:text-violet-400 border-zinc-300 w-full text-2xl">
